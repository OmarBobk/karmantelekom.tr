            ...
            <div class="w-screen max-w-md">
                <div class="h-full flex flex-col bg-white shadow-xl">
                                        ...
                                        <li class="py-6 flex items-center">
                                            ...
                                            <div class="ml-4 flex-1 flex flex-col gap-2">
                                                <div class="flex justify-between text-base font-medium text-gray-900">
                                                    ...
                                                    <div>
                                                        <p class="ml-4" x-text="`${item.price} ${item.currency}`"></p>
                                                    </div>
                                                </div>
                    ...
                    <div x-show="$store.cart.items.length > 0" class="border-t border-gray-200 py-6 px-4 sm:px-6">
                        <div class="flex justify-between text-base font-medium text-gray-900">
                            <p>Subtotal</p>
                            <p x-text="`${$store.cart.total.toFixed(2)} ${$store.cart.items[0]?.currency || ''}`"></p>
                        </div>
                        <p class="mt-0.5 text-sm text-gray-500">Shipping and taxes calculated at checkout.</p>
                        <div class="mt-6">
                            <a href="#"
                               @click.prevent="$store.cart.syncWithServer().then(() => window.location.href = '/')"
                        ...
                        <div class="mt-6 flex justify-center text-sm text-center text-gray-500">
                            <button @click="$store.cart.clear()" class="text-indigo-600 font-medium hover:text-indigo-500">
