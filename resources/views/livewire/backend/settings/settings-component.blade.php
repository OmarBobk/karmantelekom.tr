                ...
                <form wire:submit="saveSettings">
                    ...
                    @if($activeTab === 'social')
                        <div class="space-y-4">
                            ...
                            <div>
                                <label for="tiktok_url" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Tiktok URL</label>
                                <input type="url" id="tiktok_url" wire:model="settings.social.tiktok_url"
                                       class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                            <div>
