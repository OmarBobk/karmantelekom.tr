    ...
    >
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b border-gray-100">
            ...
            @if($this->unreadCount > 0)
                <button 
                    ...
                    class="text-sm text-blue-600 hover:text-blue-800 font-medium transition-all duration-200 hover:bg-blue-50 px-2 py-1 rounded disabled:opacity-50"
                >
        ...
        <div class="max-h-96 overflow-y-auto" wire:loading.class="opacity-50">
            @forelse($this->unreadNotifications as $notification)
                <div class="group flex items-start space-x-3 px-4 py-3 hover:bg-gray-50 transition-all duration-200 border-b border-gray-50 last:border-b-0 cursor-pointer"
                        ...
                        <div class="flex items-center justify-between mt-2">
                            ...
                            <div class="flex items-center space-x-2">
                                <button 
                                    ...
                                    class="text-xs text-blue-600 hover:text-blue-800 font-medium transition-all duration-200 opacity-0 group-hover:opacity-100 hover:bg-blue-50 px-2 py-1 rounded"
                                    onclick="event.stopPropagation();"
                                >
