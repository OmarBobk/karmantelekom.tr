        ...
        class="rounded-lg p-4 shadow-lg">
            <div class="flex">
                <div class="flex-shrink-0">
                    <svg x-show="type === 'success'" class="h-5 w-5 text-green-400" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                    </svg>
                    <svg x-show="type === 'error'" class="h-5 w-5 text-red-400" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"/>
                    </svg>
                    <svg x-show="type === 'warning'" class="h-5 w-5 text-yellow-400" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                    </svg>
                    <svg x-show="type === 'info'" class="h-5 w-5 text-blue-400" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="ml-auto pl-3">
                    <div class="-mx-1.5 -my-1.5">
                        <button @click="show = false" class="inline-flex rounded-md p-1.5 focus:outline-none focus:ring-2 focus:ring-offset-2" :class="{
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            ...
                            <div class="mt-4">
                                <form wire:submit.prevent="createCategory" class="space-y-4">
                                    ...
                                    <div>
                                        <label for="tr_name" class="block text-sm font-medium text-gray-700">Category Name (Turkish)</label>
                                        <input type="text"
                                               wire:model="addForm.tr_name"
                                               id="tr_name"
                                               class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition duration-150 ease-in-out">
                                    ...
                                    <div>
                                        <label for="ar_name" class="block text-sm font-medium text-gray-700">Category Name (Arabic)</label>
                                        <input type="text"
                                               wire:model="addForm.ar_name"
                                               id="ar_name"
                                               class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition duration-150 ease-in-out">
                                    ...
                                    <div class="flex items-center">
                                        <button type="button"
                                            ...
                                            <span class="sr-only">Toggle status</span>
                                            <span class="inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition-transform {{ $addForm['status'] ? 'translate-x-6' : 'translate-x-1' }}"></span>
                                        </button>
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            ...
                            <div class="mt-4">
                                <form wire:submit.prevent="updateCategory" class="space-y-4">
                                    <div>
                                        <label for="edit_name" class="block text-sm font-medium text-gray-700">Category Name (English)</label>
                                        <input type="text"
                                    ...
                                    <div>
                                        <label for="edit_tr_name" class="block text-sm font-medium text-gray-700">Category Name (Turkish)</label>
                                        <input type="text"
                                               wire:model="editForm.tr_name"
                                               id="edit_tr_name"
                                               class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition duration-150 ease-in-out">
                                    ...
                                    <div>
                                        <label for="edit_ar_name" class="block text-sm font-medium text-gray-700">Category Name (Arabic)</label>
                                        <input type="text"
                                               wire:model="editForm.ar_name"
                                               id="edit_ar_name"
                                               class="mt-1 block w-full rounded-lg border-gray-200 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition duration-150 ease-in-out">
                                    ...
                                    <div class="flex items-center">
                                        <button type="button"
                                            ...
                                            <span class="sr-only">Toggle status</span>
                                            <span class="inline-block h-4 w-4 transform rounded-full bg-white shadow ring-0 transition-transform {{ $editForm['status'] ? 'translate-x-6' : 'translate-x-1' }}"></span>
                                        </button>
