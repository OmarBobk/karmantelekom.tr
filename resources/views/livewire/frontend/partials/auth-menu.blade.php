        ...
        <div class="p-4">
            ...
            <div class="mt-3 space-y-1">
                ...
                @elseif(Auth::user()->isShopOwner())
                    <a href="{{ route('shop.profile') }}" class="flex items-center gap-x-3 px-3 py-2 text-sm text-gray-700 rounded-lg hover:gap-x-5 hover:bg-gray-50 transition-colors duration-200">
                        <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
{{--                    </a>--}}
                ...
                @role('admin|customer_salesperson')
                    <a href="{{ route('catalog', ['category' => 'all']) }}" class="flex items-center gap-x-3 px-3 py-2 text-sm text-gray-700 rounded-lg hover:gap-x-5 hover:bg-gray-50 transition-colors duration-200">
