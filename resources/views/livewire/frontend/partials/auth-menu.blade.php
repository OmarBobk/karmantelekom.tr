    ...
    <div x-show="open"
        ...
        <div class="p-4">
            ...
            <div class="mt-3 space-y-1">
                ...
                <button @click="$store.cart.logout()" class="w-full flex items-center gap-x-3 px-3 py-2 text-sm text-red-600 rounded-lg hover:gap-x-5 hover:bg-red-50 transition-colors duration-200">
                    <svg class="size-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
