                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <p class="text-2xl font-bold text-gray-900">{{ number_format($metrics['avg_order_value'], 2) }} ₺</p>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                         ...
                         <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                             ...
                             <div class="space-y-6">
                                 ...
                                 <div>
                                     ...
                                     <div class="bg-gray-50 rounded-xl px-4 py-3 text-gray-900">{{ $shop->address }}</div>
                                 </div>
                                 ...
                                 @if($shop->email)
                                     <div>
                                         ...
                                         <div class="bg-gray-50 rounded-xl px-4 py-3 text-gray-900 flex items-center">
                                             ...
                                             <a href="mailto:{{ $shop->email }}" class="text-blue-600 hover:text-blue-800">{{ $shop->email }}</a>
                                         </div>
                                     </div>
                                 @endif
                             ...
                             <div class="space-y-6">
                                 ...
                                 <div>
                                     ...
                                     <div class="bg-gray-50 rounded-xl overflow-hidden h-48">
                                         <iframe
                                             width="100%"
                                             height="100%"
                                             frameborder="0"
                                             style="border:0"
                                             src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg&q={{ urlencode($shop->address) }}"
                                             allowfullscreen
                                         ></iframe>
                                     </div>
                                 </div>
                                 ...
                                 <!-- Social Media Links -->
                                 @if($shop->links && count($shop->links) > 0)
                                     <div>
                                         ...
                                         <div class="space-y-2">
                                             @foreach($shop->links as $platform => $url)
                                                 <div class="bg-gray-50 rounded-xl px-4 py-3 flex items-center justify-between">
                                                     <div class="flex items-center">
                                                         <span class="text-sm font-medium text-gray-600 capitalize mr-2">{{ $platform }}:</span>
                                                         <a href="{{ $url }}" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm truncate">{{ $url }}</a>
                                                     </div>
                         ...
                         <div class="mt-8 pt-8 border-t border-gray-200">
                             <h3 class="text-lg font-semibold text-gray-900 mb-4">Business Documents</h3>
                             <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                 @if($shop->tax_document_path)
                                     <div>
                                         <label class="block text-sm font-medium text-gray-700 mb-2">Tax ID Document</label>
                                         <div class="bg-gray-50 rounded-xl px-4 py-3 flex items-center justify-between">
                                             <div class="flex items-center">
                                                 <svg class="w-5 h-5 text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                                                 </svg>
                                                 <span class="text-sm text-gray-900">Tax Document</span>
                                             </div>
                                             <a href="{{ Storage::url($shop->tax_document_path) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                                 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                                 </svg>
                                             </a>
                                 ...
                                 @if($shop->business_license_path)
                                     <div>
                                         ...
                                         <div class="bg-gray-50 rounded-xl px-4 py-3 flex items-center justify-between">
                                             ...
                                             <a href="{{ Storage::url($shop->business_license_path) }}" target="_blank" class="text-blue-600 hover:text-blue-800">
                                                 <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path>
                                                 </svg>
                                             </a>
                             ...
                             @if(!$shop->tax_document_path && !$shop->business_license_path)
                    ...
                    <div class="bg-white px-6 py-6">
                        ...
                        <form wire:submit.prevent="saveShopInfo" class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label for="shopEmail" class="block text-sm font-medium text-gray-700 mb-2">Email</label>
                                    <input
                                        type="email"
                                        id="shopEmail"
                                    ...
                                    >
                                    @error('shopEmail') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="taxDocument" class="block text-sm font-medium text-gray-700 mb-2">Tax ID Document</label>
                                    <input
                                        type="file"
                                        id="taxDocument"
                                        wire:model="taxDocument"
                                        accept=".pdf,.jpg,.jpeg,.png"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                                    >
                                    <p class="text-xs text-gray-500 mt-1">Accepted formats: PDF, JPG, JPEG, PNG (max 2MB)</p>
                                    @error('taxDocument') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                                
                                <div>
                                    <label for="businessLicense" class="block text-sm font-medium text-gray-700 mb-2">Business License</label>
                                    <input
                                        type="file"
                                        id="businessLicense"
                                        wire:model="businessLicense"
                                        accept=".pdf,.jpg,.jpeg,.png"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200"
                                    >
                                    <p class="text-xs text-gray-500 mt-1">Accepted formats: PDF, JPG, JPEG, PNG (max 2MB)</p>
                                    @error('businessLicense') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                            </div>
