    ...
    <div class="min-h-[60vh] flex items-center justify-center px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div class="max-w-max mx-auto text-center">
            <div class="flex flex-col items-center">
                <!-- 404 Number -->
                <p class="text-6xl sm:text-8xl font-semibold bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
                    Winds Of Roses</p>
                ...
                <div class="mt-8 flex space-x-3">
                    ...
                    <a href="{{ route('main') }}"
                       class="inline-flex items-center rounded-md border border-blue-600 bg-white px-4 py-2 text-sm font-semibold text-blue-700 shadow-sm hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                        <svg class="h-5 w-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
